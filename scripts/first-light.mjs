// `npm run first-light` — find the SpatiaLite-capable interpreter, then run
// scripts/first-light.py (exports build/first-light/ and serves it).
// Mirrors gates.mjs findPython(). Pass extra args through: `npm run first-light -- --no-serve`.
...
const r = spawnSync(
  py.command,
  [...py.prefixArgs, "scripts/first-light.py", ...process.argv.slice(2)],
